...
# meat_imputed <- as.data.frame(impute.QRILC(impute_meat, tune.sigma = 1)[[1]]) #todo imputes negative values
...
To not artificially produce more samples than we had and to reduce variation in preprocessing and measurement the means for each sample or biological replicate are calculated. 
...
p_fish_vs_meat_game <- one_sample_test_by_col(fish_vs_meat_game, fish_vs_meat_game$Group, method = t.test)

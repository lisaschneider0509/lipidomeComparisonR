...
###################################################
### code chunk number 14: pcaMethods.Rnw:420-421
###################################################
barplot(drop(errEsti$variableWiseError[, which(errEsti$evalPcs == errEsti$bestNPcs)]), xlab="Incomplete variable Index", ylab="NRMSEP")


###################################################
### code chunk number 15: pcaMethods.Rnw:445-446
###################################################
slplot(resPCA)


###################################################
### code chunk number 16: pcaMethods.Rnw:456-457
###################################################
plotPcs(resPPCA, pc=1:3, type="score")


###################################################
### code chunk number 17: pcaMethods.Rnw:469-475
###################################################
pc <- pca(iris)
